...
import com.example.clinicapplication.adapter.ConsultationFragmentAdapter;
...
public class Medicalfile extends AppCompatActivity {
    private final static String TAG = "Medical file";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_medicalfile);
        ...
        Log.d(TAG, "\n" +
                "onCreate medical activity file: started");
        getIncomingIntent();
        ...
        Log.d("sssssssssss",calendier.CurrentUserType);

    if(calendier.CurrentUserType.trim().equals("patient")){
    ...
    private void setPatientInfos(String patient_name, String patient_email, String patient_phone){
        Log.d(TAG, "\n" +
                "setPatientInfos: put patient infos");
    ...
    private void openPatientFiche(){
        Intent intent = new Intent(this,Activitysheet.class);
