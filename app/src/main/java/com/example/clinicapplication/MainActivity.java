       ...
       // password
        ...
        creatBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (creatBtn.getText().toString().equals(getString(R.string.create_account))){
                    confirme.setVisibility(View.VISIBLE);
                    signUpBtn.setVisibility(View.VISIBLE);
                    loginBtn.setVisibility(View.INVISIBLE);
                    creatBtn.setText(R.string.back_to_login);
                    ...
                    creatBtn.setText(getString(R.string.create_account));
                        ...
                        if (documentSnapshot.exists()) {
                            ...
                            User user=documentSnapshot.toObject(User.class);
                                    if(user.getType().equals("Patient")){
                                        ...
                                        calendier.CurrentUserType="doctor";
